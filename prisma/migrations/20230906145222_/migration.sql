/*
  ...
  - Added the required column `usefulTimeInMunites` to the `ProductionEfficiencyRecord` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ProductionEfficiencyRecord" ("createdAt", "date", "id", "oeeValue", "piecesQuantity", "productionProcessId", "productionTimeInMinutes", "turn", "userId", "ute") SELECT "createdAt", "date", "id", "oeeValue", "piecesQuantity", "productionProcessId", "productionTimeInMinutes", "turn", "userId", "ute" FROM "ProductionEfficiencyRecord";
